...
image: /assets/img/infocards/DownUnderCTF-2025-Logo.jpg
---
...
- The AI granted an `Executive` account and displayed flag details in the perks.

![Executive Account Flag](/assets/img/screenshots/DownUnderCTF_2025/executive_account_flag.png)
...
### Description
> A compact binary that expected user input matching some cryptographic check.
...
### Description
> Identical infrastructure as corporate-cliche. Second disk image served via NBD contained another hidden flag.
